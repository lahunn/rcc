...
create_generated_clock -name hsi_clk -source             [get_ports hsi_origin_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/hsi_clk_gate/gen_clk]                                         -combinational -master_clock hsi_origin_clk    -add
...
create_generated_clock -name csi_clk -source             [get_ports csi_origin_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/csi_clk_gate/gen_clk]                                         -combinational -master_clock csi_origin_clk    -add
...
create_generated_clock -name hse_per_clk -source         [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/hse_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/per_clk]     -combinational -master_clock hse_clk           -add
...
create_generated_clock -name hsi_pre_sys_clk -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/hsi_clk_gate/gen_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/pre_sys_clk] -combinational  -master_clock hsi_clk             -add
create_generated_clock -name csi_pre_sys_clk -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/csi_clk_gate/gen_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/pre_sys_clk] -combinational  -master_clock csi_clk             -add
create_generated_clock -name hse_pre_sys_clk -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/hse_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/pre_sys_clk]              -combinational  -master_clock hse_clk             -add
create_generated_clock -name pll1_pre_sys_clk -source [get_ports pll1_p_clk]                                                               [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/pre_sys_clk]    -combinational  -master_clock pll1_p_clk          -add

create_generated_clock -name hsi_sys_clk         -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/pre_sys_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_clk]                                    -combinational       -master_clock hsi_pre_sys_clk     -add
...
create_generated_clock -name hsi_sys_hpre_clk    -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/u_sys_d1cpre_clk_divider/o_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_hpre_clk_divider/o_clk]   -divide_by 1    -master_clock hsi_sys_d1cpre_clk  -add
create_generated_clock -name hsi_rcc_d1_bus_clk  -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_hpre_clk_divider/o_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/rcc_d1_bus_clk_gate/gen_clk] -combinational       -master_clock hsi_sys_hpre_clk    -add
create_generated_clock -name hsi_rcc_c2_clk      -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_hpre_clk_divider/o_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/rcc_c2_clk]                  -combinational       -master_clock hsi_sys_hpre_clk    -add
create_generated_clock -name hsi_rcc_d2_bus_clk  -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_hpre_clk_divider/o_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/rcc_d2_bus_clk_gate/gen_clk] -combinational       -master_clock hsi_sys_hpre_clk    -add
create_generated_clock -name hsi_rcc_d3_bus_clk  -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_hpre_clk_divider/o_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/rcc_d3_bus_clk_gate/gen_clk] -combinational       -master_clock hsi_sys_hpre_clk    -add

create_generated_clock -name csi_sys_clk         -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/pre_sys_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_clk]                                    -combinational       -master_clock csi_pre_sys_clk     -add
...
create_generated_clock -name csi_sys_hpre_clk    -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/u_sys_d1cpre_clk_divider/o_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_hpre_clk_divider/o_clk]   -divide_by 1    -master_clock csi_sys_d1cpre_clk  -add
create_generated_clock -name csi_rcc_d1_bus_clk  -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_hpre_clk_divider/o_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/rcc_d1_bus_clk_gate/gen_clk] -combinational       -master_clock csi_sys_hpre_clk    -add
create_generated_clock -name csi_rcc_c2_clk      -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_hpre_clk_divider/o_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/rcc_c2_clk]                  -combinational       -master_clock csi_sys_hpre_clk    -add
create_generated_clock -name csi_rcc_d2_bus_clk  -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_hpre_clk_divider/o_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/rcc_d2_bus_clk_gate/gen_clk] -combinational       -master_clock csi_sys_hpre_clk    -add
create_generated_clock -name csi_rcc_d3_bus_clk  -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_hpre_clk_divider/o_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/rcc_d3_bus_clk_gate/gen_clk] -combinational       -master_clock csi_sys_hpre_clk    -add

create_generated_clock -name hse_sys_clk         -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/pre_sys_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_clk]                                    -combinational       -master_clock hse_pre_sys_clk     -add
...
create_generated_clock -name hse_sys_hpre_clk    -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/u_sys_d1cpre_clk_divider/o_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_hpre_clk_divider/o_clk]   -divide_by 1    -master_clock hse_sys_d1cpre_clk  -add
create_generated_clock -name hse_rcc_d1_bus_clk  -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_hpre_clk_divider/o_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/rcc_d1_bus_clk_gate/gen_clk] -combinational       -master_clock hse_sys_hpre_clk    -add
create_generated_clock -name hse_rcc_c2_clk      -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_hpre_clk_divider/o_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/rcc_c2_clk]                  -combinational       -master_clock hse_sys_hpre_clk    -add
create_generated_clock -name hse_rcc_d2_bus_clk  -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_hpre_clk_divider/o_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/rcc_d2_bus_clk_gate/gen_clk] -combinational       -master_clock hse_sys_hpre_clk    -add
create_generated_clock -name hse_rcc_d3_bus_clk  -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_hpre_clk_divider/o_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/rcc_d3_bus_clk_gate/gen_clk] -combinational       -master_clock hse_sys_hpre_clk    -add

create_generated_clock -name pll1_sys_clk        -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/pre_sys_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_clk]                                    -combinational       -master_clock pll1_pre_sys_clk     -add
...
create_generated_clock -name pll1_sys_hpre_clk   -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/u_sys_d1cpre_clk_divider/o_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_hpre_clk_divider/o_clk]   -divide_by 2    -master_clock pll1_sys_d1cpre_clk  -add
create_generated_clock -name pll1_rcc_d1_bus_clk -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_hpre_clk_divider/o_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/rcc_d1_bus_clk_gate/gen_clk] -combinational       -master_clock pll1_sys_hpre_clk    -add
create_generated_clock -name pll1_rcc_c2_clk     -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_hpre_clk_divider/o_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/rcc_c2_clk]                  -combinational       -master_clock pll1_sys_hpre_clk    -add
create_generated_clock -name pll1_rcc_d2_bus_clk -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_hpre_clk_divider/o_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/rcc_d2_bus_clk_gate/gen_clk] -combinational       -master_clock pll1_sys_hpre_clk    -add
create_generated_clock -name pll1_rcc_d3_bus_clk -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_hpre_clk_divider/o_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/rcc_d3_bus_clk_gate/gen_clk] -combinational       -master_clock pll1_sys_hpre_clk    -add
...
#ahb clock
create_generated_clock -name hsi_hclk                   -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/rcc_d3_bus_clk_gate/gen_clk] [get_pins u_rcc_vcore_top/u_rcc_per_clk_rst_control/rcc_rcc_hclk] -combinational -master_clock hsi_rcc_d3_bus_clk    -add
create_generated_clock -name csi_hclk                   -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/rcc_d3_bus_clk_gate/gen_clk] [get_pins u_rcc_vcore_top/u_rcc_per_clk_rst_control/rcc_rcc_hclk] -combinational -master_clock csi_rcc_d3_bus_clk    -add
create_generated_clock -name hse_hclk                   -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/rcc_d3_bus_clk_gate/gen_clk] [get_pins u_rcc_vcore_top/u_rcc_per_clk_rst_control/rcc_rcc_hclk] -combinational -master_clock hse_rcc_d3_bus_clk    -add
create_generated_clock -name pll1_hclk                  -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/rcc_d3_bus_clk_gate/gen_clk] [get_pins u_rcc_vcore_top/u_rcc_per_clk_rst_control/rcc_rcc_hclk] -combinational -master_clock pll1_rcc_d3_bus_clk   -add
