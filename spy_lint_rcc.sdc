...
#==============================================================================
create_generated_clock -name sys_clk         -source [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/pre_sys_clk] [get_pins u_rcc_vcore_top/u_rcc_sys_clk_rst_ctrl/sys_clk]                                    -combinational       -master_clock pre_sys_clk     -add
...
# SET CLOCK GROUPS
#==============================================================================
set_clock_groups -name total_group -asynchronous -group [get_clocks {pre_sys_clk sys_clk sys_d1cpre_clk rcc_c1_clk sys_hpre_clk rcc_d1_bus_clk rcc_c2_clk rcc_d2_bus_clk rcc_d3_bus_clk rcc_hclk rcc_bdcr_byte0_wren rcc_bdcr_byte1_wren rcc_bdcr_byte2_wren rcc_c1_rsr_rmvf_wren rcc_c2_rsr_rmvf_wren rcc_csr_lsion_wren}] \
